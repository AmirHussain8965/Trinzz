                        ...
                        <div className="offcanvas__content">
                            <div className="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                                <div className="offcanvas__logo">
                                    <Link href="/">
                                        <img src="/assets/img/logo.png" style={{height:"40px"}} alt="logo-img" />
                                    </Link>
                                </div>
                            ...
                            <div className="offcanvas__contact">
                                ...
                                <ul>
                                    <li className="d-flex align-items-start">
                                        ...
                                        <div className="offcanvas__contact-text">
                                            <Link target="_blank" href="#">5501 DeMarcus Blvd, Apartment 242, Dublin, California 94568</Link>
                                        </div>
                                    </li>
                                    <li className="d-flex align-items-center">
                                        ...
                                        <div className="offcanvas__contact-text">
                                            <Link href="/mailto:info@azent.com"><span>hello@trinzz.com</span></Link>
                                        </div>
                                    </li>
                                    <li className="d-flex align-items-center">
                                        <div className="offcanvas__contact-icon mr-15">
                                ...
                                <div className="social-icon d-flex align-items-center">
                                    ...
                                    <Link href="https://www.youtube.com/@Trinzz" target="_blank"><i className="fab fa-youtube" /></Link>
                                    <Link href="https://www.linkedin.com/company/trinzz/" target="_blank"><i className="fab fa-linkedin-in" /></Link>
                                </div>
                            </div>
                        </div>
                    </div>
